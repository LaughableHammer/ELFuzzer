...
def mutate():
    ...
    TODO: possibly clean up. An input is sent but it may not be used. Same goes with csv
    TODO: move the encoding function into a separte file. Recommendation: FileFormat is for file utilities.
    """
    ...
    json_dict = unflatten(mutated_data, splitter="dot")
